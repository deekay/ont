      ...
      {step === "done" && result ? (
        <>
          ...
          <Card style={{ borderColor: colors.success }}>
            <View style={styles.row}>
              <Text style={[styles.cardLabel, { color: colors.success }]}>Value record accepted</Text>
              <Badge label={`seq ${result.sequence}`} tone="success" />
            </View>
            <Text style={styles.cardHint}>
              Signed locally with your owner key and verified by the resolver against the name's
              current owner and chain head before it was recorded.
            </Text>
