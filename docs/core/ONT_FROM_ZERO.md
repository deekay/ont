...
1. [BITCOIN_EXPERT_ONE_PAGER.md](../launch/BITCOIN_EXPERT_ONE_PAGER.md)
2. [BITCOIN_EXPERT_REVIEW_PACKET.md](../launch/BITCOIN_EXPERT_REVIEW_PACKET.md)
3. [ONT_IMPLEMENTATION_AND_VALIDATION.md](../launch/ONT_IMPLEMENTATION_AND_VALIDATION.md)
4. [UNIVERSAL_AUCTION_LAUNCH_MODEL.md](../launch/UNIVERSAL_AUCTION_LAUNCH_MODEL.md)
5. [LAUNCH_SPEC_V0.md](../launch/LAUNCH_SPEC_V0.md)
