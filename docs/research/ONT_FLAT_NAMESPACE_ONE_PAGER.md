...
| Anchor fee (150 vB root tx) | **~$1.50 normal / ~$15 congested** | total on-chain fee, independent of batch size |
...
| Long-tail gate | **₿0.00001/name** (≈ $1), sunk | fixed bitcoin amount, floats with BTC price; miner-fee vs PoW still open |
