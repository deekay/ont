...
See [`design/ONT_DESIGN_REQUIREMENTS.md`](./ONT_DESIGN_REQUIREMENTS.md) and
[`design/ONT_SOVEREIGNTY_MAP.md`](./ONT_SOVEREIGNTY_MAP.md).
...
- **Pkarr / Pubky** — self-sovereign keys publishing records over a DHT. ONT borrows the
  ...
  alone doesn't give you. See [`research/ONT_VS_PUBKY_PKARR.md`](../ONT_VS_PUBKY_PKARR.md).
...
take your name. See [`research/OWNER_KEY_RECOVERY.md`](../OWNER_KEY_RECOVERY.md).
...
- **Leaderless multi-publisher.** Distinct-name inserts commute; genuine conflicts resolve
  ...
  owns the root. See
  [`research/ONT_MULTI_PUBLISHER_CONVERGENCE.md`](../ONT_MULTI_PUBLISHER_CONVERGENCE.md).
...
decision. See
[`design/ONT_ACQUISITION_STATE_MACHINE.md`](../../spec/ONT_ACQUISITION_STATE_MACHINE.md),
[`design/ONT_MEV_ORDERING_ANALYSIS.md`](./ONT_MEV_ORDERING_ANALYSIS.md) §D3, and R16 in
[`design/ONT_RISK_REGISTER.md`](./ONT_RISK_REGISTER.md).
...
| **Open ascending auction** | Visible bids, soft close, returnable bond; matches L1 transparency | Sealed second-price — sidesteps MEV/relay-bid timing (see [`design/ONT_MEV_ORDERING_ANALYSIS.md`](./ONT_MEV_ORDERING_ANALYSIS.md)) |
...
[`research/ONT_ADVERSARIAL_ANALYSIS.md`](./ONT_ADVERSARIAL_ANALYSIS.md) and
[`research/ONT_DECENTRALIZATION_AND_DISCOVERY.md`](../ONT_DECENTRALIZATION_AND_DISCOVERY.md).
...
[`core/CURRENT_ARCHITECTURE_BRIEF.md`](./CURRENT_ARCHITECTURE_BRIEF.md) ·
[`core/SIMPLIFICATION_AUDIT.md`](./SIMPLIFICATION_AUDIT.md)

Design depth: [sovereignty map](./ONT_SOVEREIGNTY_MAP.md) ·
...
[MEV / ordering](./ONT_MEV_ORDERING_ANALYSIS.md) ·
[risk register](./ONT_RISK_REGISTER.md) ·
[requirements](./ONT_DESIGN_REQUIREMENTS.md)

Research / adversarial: [adversarial analysis](./ONT_ADVERSARIAL_ANALYSIS.md) ·
[multi-publisher convergence](../ONT_MULTI_PUBLISHER_CONVERGENCE.md) ·
[decentralization + discovery](../ONT_DECENTRALIZATION_AND_DISCOVERY.md) ·
[post-quantum / signature agility](../POST_QUANTUM_AND_SIGNATURE_AGILITY.md) ·
[prior art: Pubky/Pkarr](../ONT_VS_PUBKY_PKARR.md) ·
[open questions for experts](./OPEN_QUESTIONS_FOR_EXPERTS.md)
