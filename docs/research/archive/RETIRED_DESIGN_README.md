...
> **SUPERSEDED (2026-06-11):** this was `docs/design/README.md`; the reader map is now
...
*(Deeper, older mechanics live in [../research/BITCOIN_ANCHORED_NAME_ACCUMULATOR.md](../BITCOIN_ANCHORED_NAME_ACCUMULATOR.md)
