...
> and hundreds more for ~$1 denominated in bitcoin each, then resells them.
...
> **Example:** A squatter quietly registers a few hundred plausible names a month for $1 each.
...
> **Example:** A floor meant to feel like "$1 denominated in bitcoin" today could effectively
> become $4 if Bitcoin quadruples, or 25¢ if it crashes — changing how much friction it provides.
