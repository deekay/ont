...
[`../DESIGN.md`](../DESIGN.md) §10 (the clean-sheet requirements). "The design" = the Bitcoin-sequenced
...
1. **✅ T2 resolved (2026-05-23):** user-cost target set to ₿1,000 (~$1), revisit on feedback. (Was the lone 🚫.)
...
| **S2 Neutral scarce gate** | ✅ | ₿1,000 (~$1) gate (miner-fee or PoW), locally verifiable, no issuer. |
...
| **S6 Anti-squat cost one-time/sunk** | ✅ | ₿1,000 (~$1) one-time sunk; bonds returnable. No recurring/contestable squat cost. |
...
| --- | --- | --- |
| **Squatter** | ✅ | Linear sunk cost (₿1,000 × N); premium names → auction. 1M names ≈ 10 BTC (~$1M). |
...
1. **✅ T2 vs the ₿1,000 (~$1) gate — resolved (2026-05-23):** target set to ₿1,000 (~$1), revisit on feedback. Machine/IoT-at-billions (which would want ~$0.10) deferred until it pushes back.
...
See also: [`../RISKS.md`](../RISKS.md) (register + plain-language walkthrough),
