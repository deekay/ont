...
- **T2 — User cost.** Ordinary long-tail acquisition should cost far less than a
  Bitcoin on-chain transaction. **Target set to ~$1 denominated in bitcoin
  ...
  pushes back. (The $1 floats with BTC price — see R5.)
...
2. **Scale targets (T1–T3):** T2 user cost **set to ~$1** (2026-05-23, revisit on
